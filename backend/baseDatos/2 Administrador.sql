...
BEGIN
    ...
    INSERT INTO usuario (nombre, apellido, ci, email, usuario_asignado, contrasena, tipo, estado) 
    VALUES (p_nombre, p_apellido, p_ci, p_email, p_usuario_asignado, p_contrasena, p_tipo, p_estado);
    
    SET p_id_usuario = LAST_INSERT_ID();
    
    IF p_tipo = 'Tecnico' AND p_especialidad IS NOT NULL THEN
        INSERT INTO Tecnico (ID_Tecnico, Especialidad) VALUES (p_id_usuario, p_especialidad);
    ELSEIF p_tipo = 'Logistica' THEN
        INSERT INTO Logistica (ID_Logistica) VALUES (p_id_usuario);
    END IF;
