...
BEGIN
    ...
    -- Insertar el componente placa (without cantidad_usada)
    INSERT INTO componente (tipo, nombre, precio)
    VALUES ('Logistico', p_numero_placa, 120.00);
    
    SET p_id_componente = LAST_INSERT_ID();
...
END //
-- Procedimiento para obtener componentes con disponibilidad real
...
-- Updated procedure to remove cantidad_usada reference
