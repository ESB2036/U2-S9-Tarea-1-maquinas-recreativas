...
-- Procedimiento para actualizar informe de distribución
...
BEGIN
    ...
    IF EXISTS (
        ...
        WHERE ID_Maquina = p_id_maquina;
    ELSE
        -- Crear nuevo informe solo si no existe
...
-- Procedimiento para crear informe de distribución
...
-- Procedimiento para obtener informes de distribución con filtros
