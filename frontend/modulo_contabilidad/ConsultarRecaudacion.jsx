        ...
        <tbody>
          {recaudaciones.map(r => (
            <tr key={r.ID_Recaudacion}>
              ...
              <td>
                {r.ID_Informe && (
                  <button onClick={() => window.location.href = `/contabilidad/informe/${r.ID_Recaudacion}`}>Ver Informe</button>
                )}
                <button onClick={() => window.location.href = `/contabilidad/actualizar-recaudacion/${r.ID_Recaudacion}`}>Editar</button>
                <button onClick={() => {
